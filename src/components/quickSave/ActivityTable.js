      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-left text-gray-500 text-xs sm:text-sm">
            <th className="pb-2 pl-4 sm:pl-0">From</th>
            <th className="pb-2 hidden sm:table-cell">Transaction ID</th>
            <th className="pb-2">Date</th>
            <th className="pb-2 text-right pr-4 sm:pr-0">Amount</th>
          </tr>
        </thead>
        <tbody>
          {transactions.map((transaction) => (
            <tr key={transaction.id} className="border-t border-gray-100">
              ...
              <td className="py-2 sm:py-3 hidden sm:table-cell text-xs sm:text-sm">
                {transaction.transactionId}
              </td>
              <td className="py-2 sm:py-3 text-xs sm:text-sm">
                {formatDate(transaction.date)}
              </td>
              <td className="py-2 sm:py-3 text-xs sm:text-sm text-right pr-4 sm:pr-0">
