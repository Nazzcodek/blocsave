...
const FundWalletPaymentModal = ({ isOpen, onClose, onComplete, amount, showSuccess }) => {
      ...
      case "success":
        return (
          <div className="py-8 text-center">
            ...
            <p className="text-gray-600">Your wallet has been funded with {formatCurrency(amount)} USDC.</p>
          </div>
        );
        ...
        return (
          <div className="py-4">
            <p className="text-gray-600 mb-6">
              Complete your payment to fund your wallet. This process is secure and your information is protected.
            </p>
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title={paymentStatus === "success" ? "Payment Successful" : "Complete Payment"}
