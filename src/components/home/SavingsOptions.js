  ...
  return (
    ...
    >
      <div className="max-w-full sm:max-w-[70%] md:max-w-[68%] z-10 relative">
        ...
        <p className="mb-5 sm:mb-9 text-lg sm:text-xl">
          Save anytime, on your terms, with instant deposits
        </p>
        <ul className="ml-6 mb-6 sm:mb-10 space-y-3 sm:space-y-7 text-base sm:text-lg lg:text-xl">
        ...
        <button
          ...
          className="bg-[#079669] text-white py-3 px-4 sm:py-4 sm:px-6 rounded-full text-lg sm:text-xl flex items-center mb-2"
        >
          Make a quick save
          <svg
    ...
    >
      <div className="flex flex-col h-full">
        <div className="flex-1 max-w-full md:max-w-[70%] z-10 relative">
          <h3 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 sm:mb-8">
            Ajo/Adashe
            <span className="text-xl sm:text-2xl lg:text-3xl font-normal ml-2 block sm:inline">
              (group savings)
            </span>
          </h3>
          <p className="mb-5 sm:mb-9 text-lg sm:text-xl font-normal max-w-[580px]">
            Save together with friends, family, or colleagues. Pool resources
            and take turns receiving the pot.
          </p>
          <ul className="ml-6 mb-8 sm:mb-12 text-lg sm:text-xl space-y-3 sm:space-y-7 font-normal">
            <li className="flex items-start">
              <span className="mr-2">•</span>
          ...
          <button
            ...
            className="bg-white text-teal-800 py-3 px-4 sm:py-4 sm:px-6 rounded-full text-lg sm:text-xl flex items-center mb-2"
          >
            Join group savings
            <svg
              className="w-3 h-3 ml-1"
  ...
  return (
    <section className="py-10 bg-white">
      <div className="px-4 sm:px-6 md:px-12 lg:px-24 xl:px-[100px]">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-center mb-4 sm:mb-8">
          Flexible Savings Solutions
        </h2>
        <p className="text-center text-xl sm:text-2xl mb-8 sm:mb-12 max-w-3xl mx-auto text-gray-600">
